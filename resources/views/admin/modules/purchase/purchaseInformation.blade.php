...
<div class="col-md-12 mt-5 pt-3 border-bottom">
    ...
    <p class="mb-1"><a href="{{route('admin.dashboard')}}"><i class="fa fa-home"></i> Dashboard / </a><a href="{{route('admin.purchaseList')}}" >Purchases / </a><a class="active-slink">Purchase Details</a> <span class="top-date">{{date('l, jS F Y')}}</span></p>
